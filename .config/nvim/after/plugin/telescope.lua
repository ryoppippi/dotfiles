...
local function keymap()
	...
	vim.keymap.set("n", ",,", [[<cmd>Telescope find_files find_command=rg,--ignore,--hidden,--files<cr>]], key_opts)
	vim.keymap.set("n", ",f", [[<cmd>Telescope find_files find_command=rg,--ignore,--hidden,--files<cr>]], key_opts)
	vim.keymap.set("n", ",;", [[<cmd>Telescope<cr>]], { noremap = true })
	vim.keymap.set("n", ",k", [[<cmd>Telescope file_browser<cr>]], key_opts)
	vim.keymap.set("n", ",.", [[<cmd>Telescope live_grep<cr>]], key_opts)
