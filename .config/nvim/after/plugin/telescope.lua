...
vim.api.nvim_set_keymap("n", "<Leader>fs", [[<cmd>lua require('telescope.builtin').grep_string()<cr>]], key_opts)
...
vim.api.nvim_set_keymap("n", "gJ", [[<cmd>lua require('telescope.builtin').diagnostics()<cr>]], key_opts)
